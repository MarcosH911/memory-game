...
function AvatarStoreRouletteModal({
  ...
  return (
    <Dialog.Root open={showAvatarModal} onOpenChange={handleModalChange}>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-40 flex origin-center -translate-x-1/2 -translate-y-1/2 animate-show-modal flex-col items-center justify-center rounded-xl border bg-gradient-to-br from-purple-200/70 via-teal-200/70 to-yellow-200/70 px-8 py-12 shadow-2xl backdrop-blur-lg">
