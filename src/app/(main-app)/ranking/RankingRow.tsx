...
function RankingRow({ data, index, type }: RankingTableProps) {
  ...
  return (
    <tr className="flex justify-around even:bg-teal-100 h-14 items-center px-24">
      <td className="flex justify-center items-center w-[25%] text-lg font-semibold">
        {index + 1}º
      </td>
      <td className="flex justify-center items-center w-[25%]">
      ...
      <td
        className={twMerge(
          "flex justify-center items-center w-[25%] gap-1 font-semibold",
