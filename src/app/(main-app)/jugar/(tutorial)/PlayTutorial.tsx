    ...
    >
      ...
      >
        ...
        <Dialog.Content asChild>
          <div className="fixed left-1/2 top-1/2 z-50 flex h-screen w-screen -translate-x-1/2 -translate-y-1/2 animate-show-modal overflow-hidden rounded-xl border border-slate-200 shadow-2xl data-[state=closed]:animate-fade-out sm:h-[95dvh] sm:w-[32.5rem]">
            <div
              style={{
